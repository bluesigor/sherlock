...
<Note>Looking to sync permissions with your identify provider? We're working on it - [reach out](/docs/getting-started) to us to learn more</Note>

If you're self-hosting with [authentication](/self-hosting/more/authentication) enabled, you may have multiple members in your organization. Each
