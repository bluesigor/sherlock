...
Sherlock can sync code from Gitea Cloud, and self-hosted.
...
[schemas/v3/gitea.json](https://github.com/sourcebot-dev/sourcebot/blob/c201a5e1a976002c565f21fb723c4ad51ef38000/schemas/v3/gitea.json)
