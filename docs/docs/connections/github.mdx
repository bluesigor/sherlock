...
Sherlock can sync code from GitHub.com, GitHub Enterprise Server, and GitHub Enterprise Cloud.
...
<Tabs>
    <Tab title="Environment Variable">
        ...
        2. Pass this environment variable each time you run Sherlock:
        ```bash
        docker run \
            -e GITHUB_TOKEN=<PAT> \
            /* additional args */ \
...
[schemas/v3/github.json](https://github.com/sourcebot-dev/sourcebot/blob/c201a5e1a976002c565f21fb723c4ad51ef38000/schemas/v3/github.json)
