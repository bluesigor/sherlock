...
Sherlock can sync code from GitLab.com, Self Managed (CE & EE), and Dedicated.
...
[schemas/v3/gitlab.json](https://github.com/sourcebot-dev/sourcebot/blob/c201a5e1a976002c565f21fb723c4ad51ef38000/schemas/v3/gitlab.json)
