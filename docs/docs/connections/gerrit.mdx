...
<Note>Authenticating with Gerrit is currently not supported. If you need this capability, please raise a [feature request](/docs/connections/request-new).</Note>

Sherlock can sync code from self-hosted gerrit instances.
...
[schemas/v3/gerrit.json](https://github.com/sourcebot-dev/sourcebot/blob/c201a5e1a976002c565f21fb723c4ad51ef38000/schemas/v3/gerrit.json)
