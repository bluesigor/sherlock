...
export const TrialNavIndicator = ({ subscription }: Props) => {
    ...
    return (
        <Link href={`/${domain}/upgrade`} onClick={() => captureEvent('wa_trial_nav_pressed', {})}>
            <div className="flex items-center gap-2 px-3 py-1.5 bg-primary/10 border border-primary/25 rounded-full text-primary text-xs font-medium hover:bg-primary/20 transition-colors cursor-pointer">
